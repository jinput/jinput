...
#include "dxversion.h"
#include <dinput.h>
#include "net_java_games_input_windows_IDirectInput.h"
#include "util.h"
#include "winutil.h"
...
JNIEXPORT jlong JNICALL Java_net_java_games_input_windows_IDirectInput_createIDirectInput(JNIEnv *env, jclass unused) {
    LPDIRECTINPUT8 lpDirectInput;
...
JNIEXPORT void JNICALL Java_net_java_games_input_windows_IDirectInput_nEnumDevices(JNIEnv *env, jobject obj, jlong address) {
...
JNIEXPORT void JNICALL Java_net_java_games_input_windows_IDirectInput_nRelease(JNIEnv *env, jclass unused, jlong address) {
    LPDIRECTINPUT8 lpDirectInput = (LPDIRECTINPUT8)(INT_PTR)address;

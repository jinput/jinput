...
#include <jni.h>
#include <dinput.h>
#include "net_java_games_input_windows_IDirectInputDevice.h"
#include "util.h"
#include "winutil.h"
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nSetBufferSize(JNIEnv *env, jclass unused, jlong address, jint size) {
...
static jint mapGUIDType(const GUID *guid) {
	if (IsEqualGUID(guid, &GUID_XAxis)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_XAxis;
	} else if (IsEqualGUID(guid, &GUID_YAxis)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_YAxis;
	} else if (IsEqualGUID(guid, &GUID_ZAxis)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_ZAxis;
	} else if (IsEqualGUID(guid, &GUID_RxAxis)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_RxAxis;
	} else if (IsEqualGUID(guid, &GUID_RyAxis)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_RyAxis;
	} else if (IsEqualGUID(guid, &GUID_RzAxis)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_RzAxis;
	} else if (IsEqualGUID(guid, &GUID_Slider)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Slider;
	} else if (IsEqualGUID(guid, &GUID_Button)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Button;
	} else if (IsEqualGUID(guid, &GUID_Key)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Key;
	} else if (IsEqualGUID(guid, &GUID_POV)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_POV;
	} else if (IsEqualGUID(guid, &GUID_ConstantForce)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_ConstantForce;
	} else if (IsEqualGUID(guid, &GUID_RampForce)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_RampForce;
	} else if (IsEqualGUID(guid, &GUID_Square)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Square;
	} else if (IsEqualGUID(guid, &GUID_Sine)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Sine;
	} else if (IsEqualGUID(guid, &GUID_Triangle)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Triangle;
	} else if (IsEqualGUID(guid, &GUID_SawtoothUp)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_SawtoothUp;
	} else if (IsEqualGUID(guid, &GUID_SawtoothDown)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_SawtoothDown;
	} else if (IsEqualGUID(guid, &GUID_Spring)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Spring;
	} else if (IsEqualGUID(guid, &GUID_Damper)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Damper;
	} else if (IsEqualGUID(guid, &GUID_Inertia)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Inertia;
	} else if (IsEqualGUID(guid, &GUID_Friction)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_Friction;
	} else if (IsEqualGUID(guid, &GUID_CustomForce)) {
		return net_java_games_input_windows_IDirectInputDevice_GUID_CustomForce;
	} else
		return net_java_games_input_windows_IDirectInputDevice_GUID_Unknown;
}
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nGetRangeProperty(JNIEnv *env, jclass unused, jlong address, jint object_id, jlongArray range_array_obj) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
	DIPROPRANGE range;
	HRESULT res;
	jlong range_array[2];
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nGetDeadzoneProperty(JNIEnv *env, jclass unused, jlong address, jint object_id) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nSetDataFormat(JNIEnv *env, jclass unused, jlong address, jint flags, jobjectArray objects) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
	...
	clazz = (*env)->FindClass(env, "net/java/games/input/windows/DIDeviceObject");
	if (clazz == NULL)
		return -1;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nAcquire(JNIEnv *env, jclass unused, jlong address) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nUnacquire(JNIEnv *env, jclass unused, jlong address) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nPoll(JNIEnv *env, jclass unused, jlong address) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nGetDeviceState(JNIEnv *env, jclass unused, jlong address, jintArray device_state_array) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nGetDeviceData(JNIEnv *env, jclass unused, jlong address, jint flags, jobject queue, jobject queue_array, jint position, jint remaining) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
	...
	data_class = (*env)->FindClass(env, "net/java/games/input/windows/DIDeviceObjectData");
	if (data_class == NULL)
		return -1;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nEnumEffects(JNIEnv *env, jobject device_obj, jlong address, jint flags) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
	HRESULT res;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nEnumObjects(JNIEnv *env, jobject device_obj, jlong address, jint flags) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;
	HRESULT res;
	enum_context_t enum_context;
...
JNIEXPORT jint JNICALL Java_net_java_games_input_windows_IDirectInputDevice_nSetCooperativeLevel(JNIEnv *env, jclass unused, jlong address, jlong hwnd_address, jint flags) {
    LPDIRECTINPUTDEVICE8 lpDevice = (LPDIRECTINPUTDEVICE8)(INT_PTR)address;

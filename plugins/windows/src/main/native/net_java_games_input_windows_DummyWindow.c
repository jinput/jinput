...
#include <windows.h>
#include <jni.h>
#include "net_java_games_input_windows_DummyWindow.h"
#include "util.h"
...
JNIEXPORT jlong JNICALL Java_net_java_games_input_windows_DummyWindow_createWindow(JNIEnv *env, jclass unused) {
...
JNIEXPORT void JNICALL Java_net_java_games_input_windows_DummyWindow_nDestroy(JNIEnv *env, jclass unused, jlong hwnd_address) {
